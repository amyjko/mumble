...
- **Keep these current as you work.** They were all left unchecked for the first ~30 commits, which made the document say nothing was done when a third of it was. Status re-audited 2026-07-19 after the control plane landed: **77 done · 31 partial · 50 blocked · 12 not started** (170 total).
