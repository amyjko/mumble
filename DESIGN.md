...
- [ ] **UX-ROOM-3** (MVP) — A room may have multiple configurations — named snapshots of layout (objects present/visible, transforms, default transforms, capacity numbers, default location, background) — switchable during a meeting as a room-state swap all participants see.
